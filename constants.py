PIECE_SELECTED_COLOR = '#42e340' #highlight the selected piece with this color
POSSIBLE_MOVE_COLOR = '#92c74e' #highlight possible moves color
KILL_PIECE_COLOR = '#f2463d' #highlight possible piece capture color
PROTECT_PIECE_COLOR = '#4ca6f5' #highlight possible protect piece color
EMPEROR_ATTACKED_COLOR = '#8b4df7' #highlight emperor when attacked color
BASE_WIDTH = 771
BASE_HEIGHT = 771
